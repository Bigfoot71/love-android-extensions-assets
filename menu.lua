...
if isModuleAvailable("admob") then
    ads = require("admob")
end
...
function drawMenu()
	...
	centerText("LÖVE Admob 11.4",nil,320);
	setColor(255,0,0);
...
function mouseReleasedMenu(x,y)
	if checkButton(15,20,195,90) then
		...
		ads.createBanner("ca-app-pub-3940256099942544/2934735716","bottom");
	...
	elseif checkButton(600,20,780,90) then
		...
		ads.requestInterstitial("ca-app-pub-3940256099942544/4411468910");

	elseif checkButton(15,120,195,190) then
		print("isInterstitialLoaded pressed!");
		local r = ads.isInterstitialLoaded();
	...
	elseif checkButton(405,120,585,190) then
		...
		ads.requestRewardedAd("ca-app-pub-3940256099942544/1712485313");

	elseif checkButton(600,120,780,190) then
		print("isRewardedAdLoaded pressed!");
		local r = ads.isRewardedAdLoaded();
